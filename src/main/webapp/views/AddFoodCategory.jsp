...
<body>
    ...
    <div class="main">
        <div class="nav">
            ...
            <ul>
                <li><i class="fa-solid fa-list"></i> Category Form</li>
        ...
        <div class="sectionregister">
            <div class="formregi">
                ...
                <form action="saveFoodCategory" method="post">
                    <div class="forminner">
                        <input type="text" id="fullname" name="categoryName" required="required" placeholder="Enter Food Category Name">
